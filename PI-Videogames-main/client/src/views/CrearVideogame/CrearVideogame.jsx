...
import s from "./CrearVideogame.module.css";
...
export default function CreateVideogame() {
  ...
  function handlerSubmit(e) {
    ...
    swal.fire("Good job!", "You created videogame.", "success");
          ...
          <div className={s.data}>
              ...
              <div>
                ...
                {input.platforms.map((el, index) => (
                  <div key={index} className={s.divMultiSelect}>
                    ...
                    <button
                      className={s.btnMultiSelect}
                      onClick={() => {
                        handlerDeletePlatforms(el);
                      }}
                    >
                      X
                    </button>
            ...
            <div>
              ...
              <div>
                ...
                {input.genre.map((el, index) => (
                  <div key={index} className={s.divMultiSelect}>
                    <p className={s.multiSelect}>{index}</p>
                    <button
                      className={s.btnMultiSelect}
                      onClick={() => {
                        handlerDeleteGenres(el);
                      }}
                    >
                      X
                    </button>
